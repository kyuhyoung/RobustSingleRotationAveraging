function RobustSingleRotationAveraging_ReleaseCode(is_4_comparison_w_cpp)
%clc;
  %close all; 
  %clear all;
  %pkg load statistics;
  if nargin < 1
    is_4_comparison_w_cpp = false;    
  else
    is_4_comparison_w_cpp = strcmp(lower(is_4_comparison_w_cpp), 'true'); 
  endif
  if is_4_comparison_w_cpp  
    R_samples = cell(1, 7);
    R_samples(1) = [  0.87568	0.30871	0.37134; 
                        -0.015865	0.78695	-0.61681;
                        -0.48264	0.53423	0.69401 ];                    
    R_samples(2) = [  0.88084	0.27657	0.38424;
                        0.014008	0.79603	-0.60509;
                        -0.47321	0.53837	0.6973 ];
    R_samples(3) = [  0.89546	0.2712	0.35299;
                        0.012714	0.77708	-0.62928;
                        -0.44496	0.56798	0.69239 ];
    R_samples(4) = [  0.85608	0.27909	0.43502;
                        0.060279	0.78202	-0.62033;
                        -0.51332	0.55727	0.65265 ];
    R_samples(5) = [  0.87326	0.26435	0.40932;
                        0.030012	0.80926	-0.58668;
                        -0.48634	0.52461	0.69876 ];
    R_samples(6) = [  -0.33503	0.24321	-0.91028;
                        -0.061857	0.95835	0.27882;
                        0.94017	0.14972	-0.30603  ];
    R_samples(7) = [  -0.073099	0.96268	0.26058;
  ...
  R_geodesic = RobustSingleRotationAveraging_from_list_of_rotation_matrices(R_samples, 'geodesic', b_outlier_rejection, n_iterations, thr_convergence)
  time_geodesic = toc;
  ...
  R_chordal = RobustSingleRotationAveraging_from_list_of_rotation_matrices(R_samples, 'chordal', b_outlier_rejection, n_iterations, thr_convergence)
  time_chordal = toc;
